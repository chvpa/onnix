...
export const mockTasks: Task[] = [
  ...
  { id: 1, projectId: 1, title: "Diseño de wireframes del catálogo", description: "Crear wireframes para la vista de catálogo de productos", phase: "pendiente", status: "completada", assignee: "Ana CX", hoursEstimated: 8, hoursReal: 7, startDate: "2024-02-01", endDate: "2024-02-05", priority: "media", rejections: 0, auditLog: [{ id: 1, timestamp: "2024-02-05 14:30", user: "Ana CX", action: "Cambió estado", from: "en_progreso", to: "completada" }] },
  { id: 2, projectId: 1, title: "Modelo de datos de productos", description: "Definir esquema de base de datos para productos, categorías y variantes", phase: "pendiente", status: "completada", assignee: "Carlos Dev", hoursEstimated: 4, hoursReal: 5, startDate: "2024-02-06", endDate: "2024-02-08", priority: "alta", rejections: 0, auditLog: [] },
  { id: 3, projectId: 1, title: "API REST de productos", description: "Endpoints CRUD para gestión de productos", phase: "desarrollo", status: "en_progreso", assignee: "Carlos Dev", hoursEstimated: 16, hoursReal: 12, startDate: "2024-02-10", priority: "alta", rejections: 0, auditLog: [{ id: 2, timestamp: "2024-02-12 09:00", user: "Carlos Dev", action: "Cambió estado", from: "pendiente", to: "en_progreso" }] },
  { id: 4, projectId: 1, title: "Carrito de compras frontend", description: "Implementar componente de carrito con persistencia en localStorage", phase: "desarrollo", status: "en_progreso", assignee: "Pedro Dev", hoursEstimated: 12, hoursReal: 8, startDate: "2024-02-15", priority: "alta", rejections: 0, auditLog: [] },
  { id: 5, projectId: 1, title: "Integración pasarela de pagos", description: "Conectar con Stripe para procesamiento de pagos", phase: "desarrollo", status: "pendiente", assignee: "Carlos Dev", hoursEstimated: 20, hoursReal: 0, startDate: "2024-03-01", priority: "alta", rejections: 0, auditLog: [] },
  { id: 6, projectId: 1, title: "Tests E2E del checkout", description: "Pruebas automatizadas del flujo de compra completo", phase: "testing", status: "pendiente", assignee: "Laura DA", hoursEstimated: 10, hoursReal: 0, startDate: "2024-03-15", priority: "media", rejections: 0, auditLog: [] },
  { id: 7, projectId: 1, title: "Deploy a staging", description: "Configurar pipeline CI/CD y deploy a ambiente de staging", phase: "produccion", status: "pendiente", assignee: "Carlos Dev", hoursEstimated: 6, hoursReal: 0, startDate: "2024-04-01", priority: "media", rejections: 0, auditLog: [] },

  // Project 2 - App Móvil Finanzas
  { id: 8, projectId: 2, title: "Diseño UI de transferencias", description: "Pantallas de transferencia entre cuentas propias y terceros", phase: "desarrollo", status: "completada", assignee: "Ana CX", hoursEstimated: 10, hoursReal: 9, startDate: "2024-01-20", endDate: "2024-02-01", priority: "alta", rejections: 0, auditLog: [] },
  { id: 9, projectId: 2, title: "Módulo de autenticación biométrica", description: "Integrar Face ID y Touch ID para login", phase: "testing", status: "en_progreso", assignee: "Pedro Dev", hoursEstimated: 24, hoursReal: 20, startDate: "2024-02-15", priority: "alta", rejections: 1, auditLog: [] },
  { id: 10, projectId: 2, title: "Tests de seguridad", description: "Penetration testing y validación de cifrado", phase: "testing", status: "pendiente", assignee: "Carlos Dev", hoursEstimated: 16, hoursReal: 0, startDate: "2024-03-20", priority: "alta", rejections: 0, auditLog: [] },

  // Project 3 - Dashboard Analytics
  { id: 11, projectId: 3, title: "Relevamiento de métricas", description: "Definir KPIs y métricas a visualizar con el cliente", phase: "pendiente", status: "completada", assignee: "Laura DA", hoursEstimated: 6, hoursReal: 5, startDate: "2024-04-01", endDate: "2024-04-05", priority: "alta", rejections: 0, auditLog: [] },
  { id: 12, projectId: 3, title: "Diseño de dashboard", description: "Mockups de alta fidelidad del dashboard principal", phase: "pendiente", status: "en_progreso", assignee: "Ana CX", hoursEstimated: 8, hoursReal: 4, startDate: "2024-04-10", priority: "media", rejections: 0, auditLog: [] },
  { id: 13, projectId: 3, title: "Conexión a fuentes de datos", description: "Integrar APIs de fuentes de datos externas", phase: "pendiente", status: "pendiente", assignee: "Laura DA", hoursEstimated: 12, hoursReal: 0, startDate: "2024-04-20", priority: "alta", rejections: 0, auditLog: [] },

  // Project 4 - API Gateway
  { id: 14, projectId: 4, title: "Configuración de Kubernetes", description: "Setup de cluster K8s para el gateway", phase: "produccion", status: "en_progreso", assignee: "Carlos Dev", hoursEstimated: 8, hoursReal: 6, startDate: "2024-04-10", priority: "alta", rejections: 0, auditLog: [] },
  { id: 15, projectId: 4, title: "Monitoreo y alertas", description: "Configurar Grafana y Prometheus para monitoreo", phase: "produccion", status: "pendiente", assignee: "Carlos Dev", hoursEstimated: 6, hoursReal: 0, startDate: "2024-04-15", priority: "media", rejections: 2, auditLog: [] },
];
